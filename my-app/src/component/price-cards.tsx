  ...
  return (
    <section className="relative w-full  flex flex-col items-center justify-center px-4 border-t-[0.1px] border-green-100 py-10">
      ...
      <motion.div
        ...
        className="bg-gray-800/40 border border-gray-700  text-white rounded-3xl p-10 max-w-xl w-full shadow-2xl cursor-pointer relative overflow-hidden"
      >
        ...
        {/* Header */}
        <h3 className=" font-bold text-center mb-8 tracking-wider uppercase  text-slate-100 items-center  ">
        ...
        <div className="space-y-5 mb-10 ">
          {[
            ...
            >
              ...
              <p className="font-extrabold plus text-sm sm:text-lg">{feature}</p>
            </motion.div>
          ))}
        </div>
